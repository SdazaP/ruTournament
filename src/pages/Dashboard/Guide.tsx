    ...
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8 text-gray-800 dark:text-gray-200">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
            ...
            <div className="space-y-3 text-sm md:text-base">
              ...
              <div className="mt-2 text-red-400 border-l-4 border-red-500 pl-3">
                ...
                <p>
                  Si deseas borrar el torneo completo, ingresa al Panel Principal del Torneo. Activa el <strong>Modo Edición</strong> arriba a la derecha. Aparecerá un botón rojo de "Eliminar Torneo". Para confirmar, deberás escribir el nombre exacto del torneo y aceptar. Esta acción es <strong>irreversible</strong> y borrará todos los competidores y resultados.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
              <FaUsers className="text-green-500" /> 2. Gestión de Competidores
            </h2>
            <div className="space-y-3 text-sm md:text-base">
              <p>
                Ubícate en la pestaña de <strong>Competidores</strong> dentro del torneo:
              </p>
              <ul className="list-disc pl-5 space-y-2">
                <li><strong>Añadir:</strong> Usa el formulario superior para nombrar al competidor y seleccionar en qué categorías competirá. Haz clic en "Agregar Competidor".</li>
                <li><strong>Modo Edición <FaEdit className="inline" />:</strong> Al activarlo, podrás editar el nombre de un competidor o cambiar las casillas de las categorías en las que participa y luego guardar los cambios. Activar la edición también revela el ícono de eliminar, útil si alguien no se presentó.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
            ...
            <div className="space-y-3 text-sm md:text-base">
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li><strong>Modo Edición:</strong> Si te equivocaste en el nombre de un evento "Otro", o quieres ajustar las Rondas o los competidores que avanzan de una subcategoría en pleno transcurso, activa el modo edición. Podrás editar y posteriormente guardar sobre la lista activa.</li>
              </ul>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
            ...
            <div className="space-y-3 text-sm md:text-base">
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li><strong>Tiempos Base:</strong> Haciendo clic en habilitar edición, toca el espacio correspondiente al tiempo de la ronda de un competidor (ej. T1, T2...). Ingresa el tiempo numérico en segundos (ej. <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">11.45</code>) en el input.</li>
                <li><strong>Penalizaciones WCA:</strong> Debajo o a un costado del input de tiempo tendrás los botones <strong>+2</strong> y <strong>DNF</strong>. Presiónalos si el juez aplicó una penalización sobre el intento del competidor. El mejor tiempo, el peor tiempo, y el Average Oficial se recalcularán solos al apretar "Guardar".</li>
              </ul>
            </div>
          </div>
